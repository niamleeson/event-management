...
function LoadingFallback() {
    return (_jsx("div", { style: {
            ...
            fontFamily: '-apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif',
                        ...
                        margin: '0 auto 12px',
                    } }), "Loading example...", _jsx("style", { children: `@keyframes spin { to { transform: rotate(360deg); } }` })] }) }));
}
function withSuspense(Component) {
    return (_jsx(Suspense, { fallback: _jsx(LoadingFallback, {}), children: _jsx(Component, {}) }));
}
