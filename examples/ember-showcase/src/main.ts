...
const pageLoaders: Record<string, () => Promise<PageModule>> = {
  ...
  '/3d-card-flip': () => import('./pages/3d-card-flip'),
  '/3d-cube-menu': () => import('./pages/3d-cube-menu'),
  '/3d-particle-explosion': () => import('./pages/3d-particle-explosion'),
  '/3d-carousel': () => import('./pages/3d-carousel'),
  '/3d-layered-parallax': () => import('./pages/3d-layered-parallax'),
  '/3d-morphing-grid': () => import('./pages/3d-morphing-grid'),
  '/spreadsheet': () => import('./pages/spreadsheet'),
  '/chat-app': () => import('./pages/chat-app'),
  '/music-player': () => import('./pages/music-player'),
  '/virtual-scroll': () => import('./pages/virtual-scroll'),
  '/collaborative-editor': () => import('./pages/collaborative-editor'),
  '/image-filters': () => import('./pages/image-filters'),
  '/gantt-chart': () => import('./pages/gantt-chart'),
  '/notification-system': () => import('./pages/notification-system'),
  '/file-tree': () => import('./pages/file-tree'),
  '/stock-dashboard': () => import('./pages/stock-dashboard'),
  '/sortable-grid': () => import('./pages/sortable-grid'),
  '/modal-system': () => import('./pages/modal-system'),
  '/canvas-paint': () => import('./pages/canvas-paint'),
  '/data-table': () => import('./pages/data-table'),
}
