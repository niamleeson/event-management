...
export const routeInfos: RouteInfo[] = [
  { path: '/todo-list', label: 'Todo List', description: 'CRUD with on()/emit() validation' },
  { path: '/api-call', label: 'API Call', description: 'Async search with cancellation' },
  { path: '/simple-animation', label: 'Simple Animation', description: 'Animated counter with rAF' },
  ...
  { path: '/3d-card-flip', label: '3D Card Flip', description: 'Flip animation, hover scale, perspective' },
  { path: '/3d-cube-menu', label: '3D Cube Menu', description: 'Drag-rotate, snap 90\u00B0, glow' },
  ...
  { path: '/3d-layered-parallax', label: '3D Parallax', description: '5 layers, mouse tracking, day/night' },
  { path: '/3d-morphing-grid', label: '3D Morphing Grid', description: '4x4 morph shapes, staggered anim' },
  ...
  { path: '/collaborative-editor', label: 'Collab Editor', description: 'Multi-user, smooth cursors, history' },
  ...
  { path: '/sortable-grid', label: 'Sortable Grid', description: 'Drag reorder, smooth positions' },
  { path: '/modal-system', label: 'Modal System', description: 'Stacked modals, animated, backdrop' },
