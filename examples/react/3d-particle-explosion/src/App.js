...
/*  Events                                                            */
/* ------------------------------------------------------------------ */
const SpawnExplosion = engine.event('SpawnExplosion');
...
/* ------------------------------------------------------------------ */
const particles = [];
const particleCount = engine.signal(ParticlesUpdated, 0, () => particles.length);
...
function ParticleCanvas() {
    ...
    return (_jsx("canvas", { ref: canvasRef, onClick: (e) => {
...
export default function App() {
    ...
    return (_jsxs("div", { style: { width: '100%', height: '100%', position: 'relative' }, children: [_jsx(ParticleCanvas, {}), _jsxs("div", { style: {
                    position: 'absolute',
                    top: 24,
                    left: 0,
                    right: 0,
                    ...
                    gap: 24,
                    pointerEvents: 'none',
                }, children: [_jsx("h1", { style: { color: '#fff', fontSize: 22, fontWeight: 300, letterSpacing: 2 }, children: "Particle Explosion" }), _jsxs("span", { style: { color: 'rgba(255,255,255,0.5)', fontSize: 14 }, children: ["Particles: ", count] }), _jsx("button", { onClick: () => emit(ClearAll, undefined), style: {
                            pointerEvents: 'all',
                    ...
                    fontSize: 13,
                    pointerEvents: 'none',
                }, children: "Click anywhere to spawn explosions" })] }));
}
