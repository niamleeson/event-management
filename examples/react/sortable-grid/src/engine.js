...
export const DragOver = engine.event('DragOver');
export const ItemMoved = engine.event('ItemMoved');
export const ShuffleAll = engine.event('ShuffleAll');
...
const INITIAL_ITEMS = Array.from({ length: 12 }, () => makeItem());
// ---------------------------------------------------------------------------
// Signals
// ---------------------------------------------------------------------------
export const items = createSignal(INITIAL_ITEMS);
engine['_signals'].push(items);
export const dragState = createSignal({
    active: false,
    dragIndex: -1,
    overIndex: -1,
    startX: 0,
...
export const enteringIds = createSignal(new Set());
engine['_signals'].push(enteringIds);
export const exitingIds = createSignal(new Set());
